  ...
  return {
    ...
    channels: [
      ...
      },
      {
        ...
        status: "disconnected",
        notify: true,
        meta: "Bot Gateway/Webhook · 支持频道消息入口与结果回传",
      },
      {
        id: "telegram",
        name: "Telegram",
        ...
        status: "disconnected",
        notify: true,
        meta: "Bot API Webhook · 支持私聊/群聊消息入口与结果回传",
      },
      {
        id: "whatsapp",
        name: "WhatsApp",
        ...
        status: "disconnected",
        notify: true,
        meta: "Cloud API Webhook · 支持手机号会话入口与结果回传",
      },
      {
        id: "linear",
        name: "Linear",
      ...
      },
      {
        ...
        status: "disconnected",
        notify: true,
        meta: "事件订阅 Webhook · 支持飞书消息入口与机器人结果回传",
      },
      {
        id: "dingding",
        name: "DingTalk",
        ...
        status: "disconnected",
        notify: true,
        meta: "机器人 Webhook · 支持钉钉消息入口与结果回传",
      },
    ],
    assistant: {
